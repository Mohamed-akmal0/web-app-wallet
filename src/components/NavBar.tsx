    ...
    <nav className="">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          id="navbar-user"
        >
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-yellow-100 rounded-lg bg-black md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 ">
            <li>
              <span className="block py-2 px-3 text-white rounded md:bg-transparent md:text-white md:p-0 hover:text-yellow-500" onClick={() => setOpenModal(!openModal)} >
                Secret Phase
              </span>
            </li>
            <li>
